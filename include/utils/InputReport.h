...
struct InputReport {
  private:
    ...
    pdloader_report_t m_pdloader_report{
        .vendor = {0x42, 0x56, 0x5a},
        .buttons1 = 0x00,
        .buttons2 = 0x00,
        .buttons3_slider1 = 0x00,
        .slider2 = 0x00,
        .slider3 = 0x00,
        .slider4 = 0x00,
        .slider5 = 0x00,
    ...
    usb_report_t getXinputReport(const InputState &state);
    usb_report_t getPDLoaderReport(const InputState &state);
