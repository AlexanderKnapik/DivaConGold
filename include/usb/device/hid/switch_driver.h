#ifndef USB_DEVICE_HID_SWITCH_DRIVER_H_
#define USB_DEVICE_HID_SWITCH_DRIVER_H_
...
const usbd_driver_t *get_hid_switch_divacon_device_driver();
...
#endif // USB_DEVICE_HID_SWITCH_DRIVER_H_