...
const usbd_driver_t *get_hid_ps4_divacon_device_driver() {
    static const usbd_driver_t hid_ps4_divacon_device_driver = {
        .name = "PS4 Arcade",
        .app_driver = &hid_app_driver,
    ...
    return &hid_ps4_divacon_device_driver;
}

const usbd_driver_t *get_hid_ps4_compat_device_driver() {
    static const usbd_driver_t hid_ps4_compat_device_driver = {
        .name = "PS4 Compat",
        .app_driver = &hid_app_driver,
    ...
    return &hid_ps4_compat_device_driver;
}