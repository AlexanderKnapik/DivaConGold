...
#define MPR121_TOUCH_THRESHOLD (10U)
#define MPR121_RELEASE_THRESHOLD (6U)

#define MPR121_TOUCH_DEBOUNCE (1U)
#define MPR121_RELEASE_DEBOUNCE (1U)

#define MPR121_FILTER_CTRL_RISING_MHD (1U)
#define MPR121_FILTER_CTRL_RISING_NHD (1U)
#define MPR121_FILTER_CTRL_RISING_NCL (14U)
#define MPR121_FILTER_CTRL_RISING_FDL (0U)

#define MPR121_FILTER_CTRL_FALLING_MHD (1U)
#define MPR121_FILTER_CTRL_FALLING_NHD (5U)
#define MPR121_FILTER_CTRL_FALLING_NCL (1U)
#define MPR121_FILTER_CTRL_FALLING_FDL (64U)

#define MPR121_FILTER_CTRL_TOUCHED_MHD (0U)
#define MPR121_FILTER_CTRL_TOUCHED_NHD (0U)
#define MPR121_FILTER_CTRL_TOUCHED_NCL (0U)
#define MPR121_FILTER_CTRL_TOUCHED_FDL (0U)
