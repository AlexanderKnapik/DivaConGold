...
void TouchSliderLeds::setIdleColor(const Config::Color &color) { m_config.idle_color = color; };
void TouchSliderLeds::setTouchedColor(const Config::Color &color) { m_config.touched_color = color; };
